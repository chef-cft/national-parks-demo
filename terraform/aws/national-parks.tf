resource "aws_instance" "permanent_peer" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo hab svc load ${var.effortless_origin}/${var.effortless_infra} --group ${var.group} --strategy at-once --channel stable",
      "sudo hab svc load ${var.effortless_origin}/${var.effortless_inspec} --group ${var.group} --strategy at-once --channel stable",
    ]
  }
}
